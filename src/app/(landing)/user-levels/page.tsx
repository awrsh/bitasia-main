            ...
            <section className='flex items-center justify-between'>
                <div className='lg:w-[500px]'>
                    ...
                    <p className='mt-8 leading-10 text-justify'>
                        ما با هدف تسهیل فرآیند انجام معاملات و ایجاد بستری امن برای شما کاربران، سطوح کاربری متفاوتی را در بیت‌آسیا ایجاد کرده‌ایم تا کاربران بتوانند با توجه به میزان استفاده و نیاز خود، مدارک مورد نظر را بارگذاری کنند. سطوح کاربری در بیت‌آسیا شامل سه سطح بوده که جزئیات آن در زیر قابل مشاهده است.
                    </p>
                </div>
