...
const Page = () => {
    return (
        <div className='w-[80%] mt-10 mx-auto'>
            ...
            <p className='pt-12 leading-10'>امنیت حساب کاربری و دارایی کاربران، مهم‌ترین اولویت بیت‌پین است.
                تیم بیت‌پین تمامی تدابیر امنیتی برای ایجاد بستر غیرقابل هک را اندیشیده و محصولی امن به شما کاربران عزیز ارائه کرده است. اما قسمتی از امنیت هر پلتفرمی، به نحوه استفاده کاربر از آن و ملاحظات امنیتی وی برمی‌گردد.
                درواقع گام اول امنیت حساب کاربری، رعایت نکات و موارد امنیتی توسط خود کاربر است. به‌همین دلیل، بیت‌پین سعی دارد با آموزش نکات امنیتی زندگی دیجیتال، علاوه‌ بر آگاه‌سازی کاربران خود، به امن کردن حساب کاربری آن‌ها نیز کمک کند.</p>
            <div className='mt-20'>
                ...
                <ul className='mt-10 space-y-6'>
                    ...
                    <li className='relative pr-7 before:right-0 before:top-1 before:absolute before:w-3 before:h-3 before:bg-green-500 before:rounded-full '>در صورت ورود به بیت‌پین از طریق مرورگر، دقت کنید که در نوار آدرس آن، آدرس‌های رسمی بیت‌پین یعنی bitpin.ir و bitpin.org درج شده باشد.</li>
                    <li className='relative pr-7 before:right-0 before:top-1 before:absolute before:w-3 before:h-3 before:bg-green-500 before:rounded-full '>برای دانلود اپلیکیشن بیت‌پین از منابع رسمی معرفی شده در این راهنما استفاده کنید.</li>
                </ul>
            </div>
        </div>
    )
