        ...
        <div className='w-[80%] mx-auto mt-20'>
            ...
            <section className='flex items-center justify-between'>
                <div className='lg:w-[500px]'>
                    <h1 className='font-bold text-3xl'>کارمزد و خدمات تسویه در بیت پین</h1>
                    <p className='mt-8 leading-10 text-justify'>
                        در بیت‌پین با هدف حفظ و افزایش امنیت، کیفی و سرعت ارائه‌‌ی خدمات، درصدی از حجم معاملات کاربران تحت عنوان کارمزد از آنان دریافت می‌شود. با افزایش فعالیت معاملاتی کاربران، میزان این کارمزد کاهش می‌یابد و کاربران تخفیف دریافت می‌کنند. ضمنا کارمزد واریز و برداشت رمز ارز به عنوان هزینه‌ی انتقال توسط شبکه‌ی آن‌ها اخذ می‌گردد.                    </p>
                </div>
