...
const FluctuationsInDigitalCurrency = ({ currency }: Props) => {
  return (
    <div className='pt-6 lg:pt-5'>
      <h1 className=' w-fit   relative font-extrabold  text-[#407bff] text-3xl after:absolute after:w-[80%] after:-bottom-3 after:rounded-xl after:right-0 after:h-px after:bg-[#407bff]'>نوسانات ارز دیجیتال</h1>
