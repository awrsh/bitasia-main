...
const Introduction = () => {
    return (
        <div className='bg-dark_blue'>
            <div className='flex flex-col lg:flex-row bg-dark_blue lg:px-10 items-center pt-20'>
            ...
            <Image className='w-full hidden lg:block -mt-20 object-cover' src={Shape} alt=''/>
        </div>
    )
}
