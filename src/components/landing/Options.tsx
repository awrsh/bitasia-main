...
const Options = () => {
  return (
    <div className='mt-10 lg:mt-28'>
        <h1 className='text-mode text-center after:-translate-x-1/2 text-3xl relative after:absolute after:w-[300px] after:left-1/2 after:-bottom-6 after:h-px after:bg-[#407bff]'>ورود به دنیای ارز دیجیتال با بیت آسیا</h1>
