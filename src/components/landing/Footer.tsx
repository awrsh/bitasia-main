...
const Footer = () => {
  return (
    <footer className='bg-[#0f2336] px-5 lg:px-20'>
      <div className='flex flex-col lg:flex-row gap-5 lg:gap-14'>
        <div>
          <div className='relative w-[200px] h-[100px] lg:w-[300px] lg:h-[160px]'>
            <Image src={Logo} alt='' fill />
          </div>
          <p className='text-white text-xs'>پاسخگویی هر روز 9 صبح الی 17</p>
          <a className='text-white pt-2 text-xs block'>support@bitasia.ir</a>
        </div>
      ...
      <div className='py-7 flex flex-col lg:flex-row items-center justify-between'>
        <p className='text-white text-xs'>طراحی سایت بـیـت‌آسیـا</p>
